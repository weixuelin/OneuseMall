...
abstract class BaseAdapter<T>(var context: Context, var list: ArrayList<T>,var click: View.OnClickListener) : androidx.recyclerview.widget.RecyclerView.Adapter<androidx.recyclerview.widget.RecyclerView.ViewHolder>() {
