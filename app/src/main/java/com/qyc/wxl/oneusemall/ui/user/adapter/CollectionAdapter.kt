...
class CollectionAdapter(context: Context, list: ArrayList<MessageInfo>) : ProBaseAdapter<MessageInfo>(context, list) {
...
//        vh.text_content.text = info.content
    ...
    inner class VH(view: View) : RecyclerView.ViewHolder(view) {
        val image_collection_icon = view.image_collection_icon
